...
import static org.kf5.support.fastjson.util.ASMUtils.getDesc;
import static org.kf5.support.fastjson.util.ASMUtils.getType;
...
import org.kf5.support.fastjson.asm.ClassWriter;
import org.kf5.support.fastjson.asm.FieldVisitor;
import org.kf5.support.fastjson.asm.Label;
import org.kf5.support.fastjson.asm.MethodVisitor;
import org.kf5.support.fastjson.asm.Opcodes;
import org.kf5.support.fastjson.parser.Feature;
import org.kf5.support.fastjson.parser.ParserConfig;
import org.kf5.support.fastjson.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(org.kf5.support.fastjson.asm.Type.getType(getDesc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(org.kf5.support.fastjson.asm.Type.getType(getDesc(itemClass)));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(org.kf5.support.fastjson.asm.Type.getType(getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          "Lcom/alibaba/fastjson/parser/deserializer/ObjectDeserializer;");
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(org.kf5.support.fastjson.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(org.kf5.support.fastjson.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
