...
public class Test {
	...
	public static void main(String[] args) {
		...
		// kf5Support.initWithApiToken("xxxxx.kf5.com", "123xxxx9@qq.com",
		// "71662da0axxxxxxxx137a");
		// kf5Support.initWithPassword("xxxxx.kf5.com", "1xxxxxx@qq.com",
		// "11xxxxx");
		...
		// for?\"}}}");
		// kf5Support.updateAgentOrder("2279","{ticket:{title:
		// \"你在哪里\",\"comment\": {\"content\": \"what are you waiting
		// for?\"}}}");
		// kf5Support.updateManyAgentOrder("1", "{\"ticket\": {\"title\":
		// \"我是你大爷\"}}");
		...
		// kf5Support.createOrderByEndUser("{\"request\":{\"title\":
		// \"被雷焦的新工单标题\",\"comment\": {\"content\": \"大家好，我是一条新工单?\"}}}");
		// kf5Support.replyOrderByEndUser("520", "{\"request\":{\"title\":
		// \"你大爷\",\"comment\": {\"content\": \"what are you waiting
		// for?\"}}}");
		// kf5Support.replyOrderByEndUser("520", "{\"request\":{\"title\":
		// \"你大爷\",\"comment\": {\"content\":
		...
		// kf5Support.updateGroup("13436", "{\"group\": {\"name\":
		// \"Interesting123 Group\"}}");
		...
		// Organization\"}}");
		// kf5Support.updateOrganization("16004","{\"organization\":
		...
		// kf5Support.createQuestion("{\"question\": {\"title\":
		// \"我是你大爷\",\"topic_id\": 8881,\"content\": \"this is content\"}}");
		// kf5Support.updateQuestion("3301", "{\"question\": {\"title\":
		// \"修改标题\"}}");
		...
		// kf5Support.updateCategory("12268", "{\"category\": {\"title\":
		// \"商户合作1\"}}");
