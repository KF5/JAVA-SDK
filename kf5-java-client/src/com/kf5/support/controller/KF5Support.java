...
public class KF5Support extends BaseSupport {
     ...
     * 带筛选条件获取客服所有的工单列表
     *
     * @param query 筛选规则: created_start 按创建时间筛选，开始时间; created_end 按创建时间筛选，结束时间;
     ...
     * 创建工单 调用权限：客服
     *
     * @param jsonString 参数格式为json字符串格式，参数格式详情请见：http://developer.kf5.com/restfulapi/
     ...
     * @param jsonString 更新内容，参数格式为json字符串格式，参数格式详情请见：http://developer.kf5.com/
     ...
     *
     * @param query 筛选条件 created_order：按创建时间排序规则，可选值：asc,desc (默认为desc)
     ...
     *
     * @param order_id 工单id
     * @param query    page 页码，默认为 1; per_page 分页尺寸，默认为 100;
     ...
     *
     * @param order_id 工单id
     * @param query    筛选条件 sort_order：排序规则，可选值：asc,desc (默认为asc)
     ...
     * 分页获取用户列表，调用权限：agent
     *
     * @param query 筛选条件 role 用户角色，可选值：admin、agent、end_user，可组合使用如：admin,agent;
     ...
     * 创建用户信息 调用权限:agent
     *
     * @param jsonString 参数格式为json字符串，具体示例请参考http://developer.kf5.com/restfulapi/core/
     ...
     * @param jsonString 需要与之合并的用户内容，格式为json字符串格式。 URL里指定id的用户，将会被合并到传递参数中id所代表的用户。
     ...
     *
     * @param query 筛选条件 page 第几页 per_page 每页数量
     * @return
     */
     ...
     *
     * @param query 筛选条件 page 页码，默认为 1; per_page 分页尺寸，默认为 100;
     * @return
     */
     ...
     *
     * @param group_id   客服组id
     * @param jsonString 修改内容,参数格式为json，详情请见http://developer.kf5.com/restfulapi/core/
     ...
     *
     * @param query 筛选条件 created_start 按创建时间筛选，开始时间; created_end 按创建时间筛选，结束时间;
     *              updated_start 按更新时间筛选，开始时间; updated_end 按更新时间筛选，结束时间;
     *              created_order 按创建时间排序，可选值：asc、desc; updated_order
     *              按更新时间排序，可选值：asc、desc page 页码，默认为 1; per_page 分页尺寸，默认为 100;
     *              备注：按创建和更新时间进行筛选的参数
     ...
     * 创建公司组织 调用权限:admin
     *
     * @param jsonString 提交内容，参数格式为json格式，详情请见http://developer.kf5.com/restfulapi/core/
     ...
     *
     * @param organization_id 公司组织id
     * @param jsonString      修改的内容，参数格式为json。详情请见http://developer.kf5.com/restfulapi/core/
     ...
     * 创建社区话题 调用权限：admin
     *
     * @param jsonString 社区话题内容，参数格式为json格式，详情请见：http://developer.kf5.com/restfulapi/
     ...
     *
     * @param topic_id   话题id
     * @param jsonString 修改内容，内容格式为json格式，详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param jsonString 创建问题内容，格式为json格式，详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param question_id 社区问题id
     * @param jsonString  修改内容，格式为json格式，详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param question_id 社区问题id
     * @param jsonString  回复内容，参数格式为json格式，详情请见http://developer.kf5.com/restfulapi/
     ...
     * 创建文档分区 调用权限：admin
     *
     * @param jsonString 提交的内容;格式为json字符串格式,详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param category_id 文档分区id
     * @param jsonString  修改内容;参数格式为json格式;详情请见：http://developer.kf5.com/restfulapi/
     ...
     * 创建文档分类 调用权限：admin
     *
     * @param jsonString 参数格式为json格式，详情请见http://developer.kf5.com/restfulapi/helpcenter
     ...
     * 创建文档 调用权限:admin
     *
     * @param jsonString 创建文档的内容；格式为json，参数格式详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param post_id    文档id
     * @param jsonString 修改文档的内容;格式为json，参数格式详情请见：http://developer.kf5.com/restfulapi/
     ...
     *
     * @param post_id    文档id
     * @param jsonString 回复内容;参数格式为json格式，详情请见:http://developer.kf5.com/restfulapi/
     ...
     *
     * @param jsonString 提交的工单内容，参数格式为json，详情请见http://developer.kf5.com/restfulapi/
     ...
     *
     * @param chat_id 会话id {@link Chat#getId()}
     * @return 返回某个对话的详细内容
     ...
     *
     * @param query 筛选参数: category_id 所属问题分组ID; page 页码，默认为 1; per_page 分页尺寸，默认为
     *              100
     * @return
     */
     ...
     * 删除机器人的某些问题题库，支持批量删除
     *
     * @param params 需要批量删除的题库的id参数。具体格式为{"ids": [13,14]}
     */
     ...
     *
     * @param query 筛选参数: page 页码，默认为 1 ;per_page 分页尺寸，默认为 100
     * @return
     */
     ...
     *
     * @param params 请求参数可包括 query:查询关键词，模糊查询多个字段; status: 查询筛选条件，例如：open,solved;
     *               fieldvalue:自定义字段条件;
     ...
     * 查看指定的id触发器 调用权限：admin
     *
     * @param url 触发器url,{@link Trigger#getUrl()}
     * @return
     */
     ...
     * 根据url查看自动化任务
     *
     * @param url {@link Automation#getUrl()}
     * @return
     */
     ...
     * 根据url获取对话列表
     *
     * @param url 请求地址 {@link KF5PaginationEntity#getNextPage()}
     * @return
     */
     ...
     * 调用权限：agent
     *
     * @param chat_id 对话id {@link Chat#getId()}
     ...
     * 调用权限：admin
     *
     * @param url {@link KF5PaginationEntity#getNextPage()}
     * @return
     */
     ...
     * 调用权限：admin or agent
     *
     * @param id 资源id {@link VoiceAccount#getId()}
     *           更多请访问：http://developer.kf5.com/restfulapi/voice/advance/#
     *           advance-agent
     * @return
     */
     ...
     *            </P>
     *            group_id:客服组ID(非必填)
     * @param map 更多请访问：http://developer.kf5.com/restfulapi/voice/advance/#
     ...
     * 调用权限：admin
     *
     * @param id {@link AgentVoiceStatus#getUser_id()}
     *           更多请访问：http://developer.kf5.com/restfulapi/voice/advance/#
     ...
     *
     * @param ticketId   工单id
     * @param jsonString 封装评价内容。
     *                   例如：{"satisfaction": {"score": 1, "content": "这是评价内容"}}
     *                   具体传参内容请参考： http://developer.kf5.com/restfulapi/core/requests/#requests-score
     * @return kf5Entity
     * 注意：满意度评价必须是工单发起人且角色必须是end_user。
     */
    public KF5Entity<Object> scoreTicketByTicketId(int ticketId, String jsonString) {
        return dealBaseMessage(new KF5Entity<>(), sendPostRequest(KF5Interface.scoreTicketById(getDomain(), ticketId), jsonString));
    }
     ...
     * 调用权限：end_user
     *
     * @param ticketId 工单id；注意：催单必须是工单发起人且角色必须是end_user；详情请参考：http://developer.kf5.com/restfulapi/core/requests/#requests-push
     * @return kf5Entity
     */
    public KF5Entity<Object> endUserTicketPushById(int ticketId) {
        return dealBaseMessage(new KF5Entity<>(), sendGetRequest(KF5Interface.ticketPushById(getDomain(), ticketId)));
    }
     ...
     * 调用权限：end_user
     *
     * @param queryMap 搜索的参数集合。
     *                 目前支持的参数key：
     *                 <ul>
     *                 <li>query:搜索关键词，在未使用参数 exact_query_fields 的时候该参数必填</li>
     *                 <li>query_fields:搜索的字段名，多个字段用英文逗号分割，可选值：name、email、phone、landline、wechat_openid</li>
     *                 </ul>
     *                 更多请浏览：http://developer.kf5.com/restfulapi/core/users/#users-search
     */
    public KF5PaginationEntity<List<User>> endUserSearchUser(Map<String, String> queryMap) {
        return buildPaginationUserList(sendGetRequest(KF5Interface.endSearchUser(getDomain(), queryMap)));
    }

    /**
     * 帮助中心帮助文档统计：http://developer.kf5.com/restfulapi/helpcenter/stats/
     * <p>
     * 调用权限：end_user
     *
     * @param queryMap 查询参数集
     *                 <ul>
     *                 <li>type:需要统计的类型; post(帮助文档)、vote（文档投票)、view（文档查看)、 comment(文档回复)</li>
     *                 <li>start:需要统计的起始时间,请使用 2018-01-01 格式</li>
     *                 <li>end :需要统计的结束时间,请使用 2018-01-01 格式</li>
     *                 </ul>
     * @return
     */
    public KF5Entity<List<DocumentStats>> endUserGetHelpCenterStats(Map<String, String> queryMap) {
        return buildDocumentStatsList(sendGetRequest(KF5Interface.endUserGetHelpCenterStats(getDomain(), queryMap)));
    }

    /**
     * 文档投票列表：http://developer.kf5.com/restfulapi/helpcenter/posts/#posts-vote-list
     * <p>
     * 调用权限：admin
     *
     * @param postId 文档id
     */
    public KF5Entity<List<PostVote>> adminGetPostVoteListByPostId(String postId) {
        return buildPostVoteList(sendGetRequest(KF5Interface.adminGetPostVoteListById(getDomain(), postId)));
    }

    /**
     * 查看指定受理客服的工单：http://developer.kf5.com/restfulapi/core/tickets/#tickets-view-many
     * <p>
     * 调用权限：admin
     *
     * @param userId   客服id
     * @param queryMap 筛选条件集
     * @return
     * @see #getAgentOrderListWithID(String)
     * @see #getAgentOrderListWithID(String, String)
     * @see #getAgentOrderListByURL(String)
     */
    public KF5Entity<List<Ticket>> adminGetAgentOrderListByAgentId(String userId, Map<String, String> queryMap) {
        return getAgentOrderListByURL(KF5Interface.adminGetOrderListByAgentId(getDomain(), userId, queryMap));
    }


    /**
     * 根据用户唯一标示返回该用户创建的工单列表：http://developer.kf5.com/restfulapi/core/users/#users-search-by-unique
     * <p>
     * 调用权限：agent
     *
     * @param queryMap 筛选条件集
     *                 <ul>
     *                 <li>query(支持邮箱或者手机号)</li>
     *                 </ul>
     * @return
     */
    public KF5Entity<List<Ticket>> agentGetUserTicketListByIndication(Map<String, String> queryMap) {
        return buildTicketList(sendGetRequest(KF5Interface.agentGetUserTicketListByIndication(getDomain(), queryMap)));
    }
}
